            ...
            <main className=" w-full">
               <div className="flex w-full flex-col">
                    ...
                    <section className="w-full bg-BgSecondary flex -mt-32 justify-center ">
                       <div className="h-auto w-full max-w-[1400px] gap-5  md:flex-row md:justify-around md:items-end  bg-BgSecondary text-BgPrimary flex flex-col items-center text-center py-10">
